      ...
      <section className="border-t border-neutral-800 bg-neutral-950 text-neutral-300">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid gap-10 md:grid-cols-3">
            <div>
              <h3 className="text-lg font-semibold text-white">{t.common.company}</h3>
            ...
            <div>
              <h4 className="text-sm font-semibold text-white">{t.common.features}</h4>
              <ul className="mt-4 space-y-2 text-sm">
                ...
                <li>{t.common.features}</li>
              </ul>
            </div>

            <div>
              <h4 className="text-sm font-semibold text-white">{t.common.legal}</h4>
              <ul className="mt-4 space-y-2 text-sm">
                <li>
                  <a
                    href="/impressum"
          ...
          <div className="mt-10 flex flex-col gap-3 border-t border-neutral-800 pt-6 text-sm text-neutral-500 md:flex-row md:justify-between">
            <span>
              © {new Date().getFullYear()} {t.common.company}.{" "}
