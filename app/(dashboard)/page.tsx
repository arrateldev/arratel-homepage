...
export default function HomePage() {
  return (
    <main className="bg-background text-foreground">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
              Start free. Upgrade when it actually makes sense.
            </h2>

            <p className="mt-4 text-lg text-muted-foreground">
              No bloated plans, no weird enterprise tiers. Just a clean free
              option and a pro upgrade for people who need more.
            </p>
          </div>
          ...
          <div className="mt-12 grid gap-6 lg:grid-cols-2">
            <div className="group relative overflow-hidden rounded-[28px] border border-border/70 bg-card p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              ...
              <p className="mt-4 text-sm leading-6 text-muted-foreground">
                Perfect for trying the product, small workloads, and getting a
                feel for the workflow before paying anything.
              </p>
            ...
            <div className="group relative overflow-hidden rounded-[28px] border border-primary/20 bg-card p-8 shadow-sm ring-1 ring-primary/10 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
              ...
              <div className="relative">
                ...
                <p className="mt-4 text-sm leading-6 text-muted-foreground">
                  For users who want fewer limits, faster workflows, and a
                  smoother path for daily use.
                </p>
      ...
      <section className="border-t border-neutral-800 bg-neutral-950 text-neutral-300">
        <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
          <div className="grid gap-10 md:grid-cols-3">
            <div>
              <h3 className="text-lg font-semibold text-white">Your Product</h3>
              <p className="mt-3 max-w-sm text-sm text-neutral-400">
                Simple tools for everyday workflows. Built with a focus on
                privacy, performance and clean user experience.
              </p>
            </div>
          ...
          <div className="mt-10 flex flex-col gap-3 border-t border-neutral-800 pt-6 text-sm text-neutral-500 md:flex-row md:justify-between">
            <span>
