...
export default async function FaqPage({
  ...
  return (
    <div className="bg-background">
      <section className="page-aura-surface relative overflow-hidden border-b border-border/60">
        <div className="page-aura-overlay pointer-events-none absolute inset-x-0 top-0 h-24" />
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="flex flex-wrap gap-3">
              <span className="inline-flex items-center rounded-full border border-border/70 bg-background/80 px-3 py-1 text-sm font-medium text-muted-foreground backdrop-blur">
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          ...
          <aside className="xl:sticky xl:top-24 xl:self-start">
            <div className="page-aura-card rounded-[28px] border border-border/70 p-6 shadow-sm">
